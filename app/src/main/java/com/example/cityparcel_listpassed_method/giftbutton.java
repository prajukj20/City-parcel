 ...
 * Use the {@link giftbutton#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Agiftbutton extends Fragment {
     ...
     * @return A new instance of fragment giftbutton.
     */
    // TODO: Rename and change types and number of parameters
    public static giftbutton newInstance(String param1, String param2) {
        giftbutton fragment = new giftbutton();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_giftbutton, container, false);
        giftbutton = view.findViewById(R.id.summit);

        Name = view.findViewById(R.id.Giftname);
        ...
        giftbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                helper.addgift(null, name, description, Faverites, Review, image, prize);
            }
        });
        return view;
